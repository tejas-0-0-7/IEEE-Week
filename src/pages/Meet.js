  ...
  return (
    <div>
      ...
      <Container className="my-4">
        ...
        <Row className="justify-content-center sec1">
          <Col xs={12} sm={6} md={4} className="mx-auto">
            <Card className="team-card">
              <Card.Img
                variant="top"
                src="/images/Archana_H_R.jpg"
        ...
        <Row className="team-row sec1">
          <Col xs={12} sm={6} md={3}>
            <Card className="team-card">
              <Card.Img
                variant="top"
                src="/images/aadhya.png"
                alt="Team Member 1"
                className="team-image"
              />
              <Card.Body>
        ...
        <div className="section-3">
          <header className="text-center my-4">
            <h1 className="section-header">Tech Leads</h1>
          </header>
        </div>
        <Row className="team-row sec1 sec2">
          <Col xs={12} sm={6} md={3}>
            <Card className="team-card">
              <Card.Img
                variant="top"
          ...
          <Col xs={12} sm={6} md={3}>
            <Card className="team-card">
              ...
              />
              <Card.Body>
                <Card.Title className="team-name">Shivani Shastry</Card.Title>
              </Card.Body>
            </Card>
          </Col>
          <Col xs={12} sm={6} md={3}>
